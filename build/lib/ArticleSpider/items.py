...
from ArticleSpider.models.es import Post,Job
from elasticsearch_dsl.connections import connections
es = connections.create_connection(Post._doc_type.using)
...
class ZhihuQuestionItem(scrapy.Item):
    ...
    def get_insert_sql(self):
        ...
        answer_num = self["answer_num"] if "answer_num" not in self else 0
...
class LagouJob(scrapy.Item):
    ...
    def save_es(self):
        ...
        job.suggest = gen_suggest(Post._doc_type.index, ((job.title,10),(job.tags,7)))
